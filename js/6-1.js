...
const getUserNames = (array) => array.map((array, {name}) => array.name);
...
// Ожидается массив всех имен из исходного массива
// Ожидается использование деструктурирущего присваивания - ({name})
// Ожидается использование метода 'map'
...
// Ожидается массив всех имен из случайного исходного массива
